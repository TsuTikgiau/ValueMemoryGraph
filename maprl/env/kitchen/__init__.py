...
register(
    id='kitchen-complete-render-v0',
    entry_point='maprl.env.kitchen.kitchen_envs:KitchenMicrowaveKettleLightSliderV0Render',
...
register(
    id='kitchen-mixed-render-v0',
    entry_point='maprl.env.kitchen.kitchen_envs:KitchenMicrowaveKettleBottomBurnerLightV0Render',
    max_episode_steps=280,
    kwargs={
        'ref_min_score': 0.0,
        'ref_max_score': 4.0,
